...
const Footer = () => {
  ...
  <div className='mt-10'>
    <p className='text-verde1 flex justify-center mt-4 font-extrabold'>Autores</p>
    <p className='text-verde1 flex justify-center mt-4 font-extrabold'>Todos os produtos</p>
    <p className='text-verde1 flex justify-center mt-4 font-extrabold'>Termos de uso</p>
  </div>
  ...
  <div className='text-center mt-10'>
          ...
          <h3 className='text-2xl font-extrabold text-verde1 mb-4 mt-10'>Apoio</h3>
