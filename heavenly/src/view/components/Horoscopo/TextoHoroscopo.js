  ...
  return (
    <div className='mt-12'>
      <div className='bg-verde2 p-6 rounded-lg shadow-lg w-full md:w-3/4 mx-auto mt-72 w-11/12'>
        {hasData ? (
          <>
            <h1 className='text-3xl font-bold mb-4 text-white mt-4'>{titulo}</h1>
            <p className='text-white mb-6 text-sm'>{data}</p>
            <hr className="my-4 border-t-2 border-gray-300" />
            <p className='mt-4 text-justify text-white mb-6 text-sm'>{texto}</p>
          </>
        ) : (
