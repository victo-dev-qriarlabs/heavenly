...
const DuvidasComuns = () => {
  ...
  return (
    ...
    <div className='w-full px-4 p-6 bg-white md:h-80 xl:h-[400px]'>
      ...
      <p className='text-verde2 mb-6 text-sm md:text-lg md:text-center md:p-8 xl:text-2xl xl:p-16 xl:px-44'>
  ...
  <div className='flex justify-end mb-10 text-xl xl:px-44 xl:mb-32'>
