  ...
  return (
    <div className='mt-12'>
      <div className='bg-verde2 p-6 rounded-lg shadow-lg w-full md:w-11/12 lg:w-10/12 mx-auto mt-40'>
        <h1 className='text-3xl font-bold mb-4 text-white'>Historia e Mitologia de Signo</h1>
        <p className='mt-4 text-center text-white mb-6 text-sm'>
      ...
      <div className='bg-verde2 p-6 rounded-lg shadow-lg w-full md:w-11/12 lg:w-10/12 mx-auto mt-1'>
        <h1 className='font-black text-2xl mt-4 text-white '>Constelacao de Zodiaco</h1>
        <p className='mt-4 text-center text-white mb-6 text-sm'>
      ...
      <div className='bg-verde2 p-6 rounded-lg shadow-lg w-full md:w-11/12 lg:w-10/12 mx-auto mt-2'>
        <h1 className='font-black text-2xl mt-4 text-center text-white'>A influencia da Constelacao</h1>
        <p className='mt-4 text-center text-white mb-6 text-sm'>
