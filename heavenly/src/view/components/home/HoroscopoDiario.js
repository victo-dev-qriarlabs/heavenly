...
const HoroscopoDiario = () => {
  return (
    <div className='container mx-auto px-4 mt-12 mb-16'>
      <h2 className='text-4xl font-extrabold mb-6 text-verde2 text-center'>HORÓSCOPO DO DIA</h2>
      <p className='text-sm mb-8 text-verde2 leading-relaxed text-center'>
      ...
      <h2 className='text-center text-2xl font-bold text-verde2'>SIGNOS</h2>
      <div className='grid grid-cols-2 gap-8 mt-16'>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-sm text-black text-center mt-2'>Otimista, Líder, Impaciente, Orgulhoso</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>ÁRIES</h3>
        </div>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-sm text-black text-center mt-2'>Determinado, Paciente, Teimoso, Desconfiado</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>TOURO</h3>
        </div>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-sm text-black text-center mt-2'>Charmoso, Inteligente, Inquieto, Desorganizado</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>GÊMEOS</h3>
        </div>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-sm text-black text-center mt-2'>Sentimental, Romântico, Temperamental, Rancoroso</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>CÂNCER</h3>
        </div>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-sm text-black text-center mt-2'>Perfeccionista, Gentil, Obsessivo, Crítico</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>VIRGEM</h3>
        </div>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-sm text-black text-center mt-2'>Conciliador, Simpático, Indeciso, Inconstante</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>LIBRA</h3>
        </div>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-sm text-black text-center mt-2'>Ambicioso, Esperto, Teimoso, Desconfiado</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>ESCORPIÃO</h3>
        </div>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-sm text-black text-center mt-2'>Leal, Sincero, Descuidado, Exagerado</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>SAGITÁRIO</h3>
        </div>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-sm text-black text-center mt-2'>Honesto, Calmo, Rígido, Calculista</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>CAPRICÓRNIO</h3>
        </div>
        <div className='flex flex-col items-center'>
          <div className='w-24 h-24 rounded-full bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 flex items-center justify-center'>
            <img src="https://img.icons8.com/office/64/aquarius.png" alt="aquarius" className='w-16 h-16'/>
          </div>
          <p className='text-sm text-black text-center mt-2'>Criativo, Racional, Nervoso, Radical</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>AQUÁRIO</h3>
        </div>
        <div className='flex flex-col items-center'>
          <div className='w-24 h-24 rounded-full bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 flex items-center justify-center'>
            <img src="https://img.icons8.com/office/64/pisces.png" alt="pisces" className='w-16 h-16'/>
          </div>
          <p className='text-sm text-black text-center mt-2'>Bondoso, Compassivo, Dependente, Submisso</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>PEIXES</h3>
        </div>
        <div className='flex flex-col items-center'>
          ...
          <p className='text-sm text-black text-center mt-2'>Sedutor, Carismático, Exagerado, Dramático</p>
          <h3 className='mt-2 text-lg font-bold text-verde2'>LEÃO</h3>
        </div>
      </div>
    </div>
  );
