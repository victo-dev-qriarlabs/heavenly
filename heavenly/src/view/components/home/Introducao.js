      ...
      <div className='absolute inset-0 bg-black opacity-50 '></div>
         <div className='relative z-10 text-center px-8 py-12 flex flex-col lg:flex-row items-center w-full md:px-32 lg:px-32 md:py-20 lg:py-32 '>
           <div className='md:text-left xl:p-48'>
            <h1 className='text-3xl font-bold mb-4 text-white lg:text-6xl'>HEAVENLY</h1>
            <p className='text-white mb-6 text-sm lg:text-2xl'>Descubra os segredos do cosmos com nossas previsões diárias. Na Heavenly, explore como as estrelas e planetas influenciam sua vida.</p>
           </div>
