...
const OqueHoroscopo = () => {
  return (
    <>
      <div className='container mx-auto px-4 bg-verde2 p-1 '>
        <h2 className='text-2xl font-extrabold mb-5 text-white text-center mt-10 text-bold'>INTRODUÇÃO HOROSCOPO</h2>
        <p className='text-xs mb-8 text-gray-700  text-center text-white'>
