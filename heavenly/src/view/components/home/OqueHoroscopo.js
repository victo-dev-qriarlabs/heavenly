...
const OqueHoroscopo = () => {
  return (
    <>
      <div className=' px-4 bg-verde2 p-1 '>
        <h2 className='text-2xl font-extrabold mb-5 text-white text-center mt-10 text-bold  xl:text-4xl'>INTRODUÇÃO HOROSCOPO</h2>
        <p className='text-xs mb-8 text-center text-white xl:text-2xl xl:p-16 xl:px-44'>
