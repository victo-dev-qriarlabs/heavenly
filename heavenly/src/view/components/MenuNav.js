...
function MenuNav() {
  return (
    <>
      <div className="fixed left-0 top-0 w-full z-50 bg-verde2">
        <div className="container mx-auto flex justify-between items-center p-6 px-6 lg:px-0 relative">
          ...
          <label className="peer-checked:hamburguer lg:hidden peer-checked:border-2 peer-checked:border-verde1 p-3 rounded-md transition-all flex flex-col items-center justify-center"
            htmlFor="teste">
            <div className="w-7 h-0.5 rounded bg-verde1 transition-all duration-300 mb-1"></div>
            <div className="w-7 h-0.5 rounded bg-verde1 transition-all duration-300 mb-1"></div>
            <div className="w-7 h-0.5 rounded bg-verde1 transition-all duration-300"></div>
          </label>

          <div className="absolute inset-0 flex flex-col items-center justify-center text-lg font-bold " style={{ zIndex: -10, pointerEvents: 'none' }}>
