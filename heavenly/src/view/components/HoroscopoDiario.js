...
const signos = [
  ...
  { nome: 'gêmeos', imagem: 'https://img.icons8.com/office/64/gemini.png', descricao: 'Charmoso, Inteligente, Inquieto, Desorganizado', gradiente: 'bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500' },
  ...
  { nome: 'escorpião', imagem: 'https://img.icons8.com/office/64/scorpio.png', descricao: 'Ambicioso, Esperto, Teimoso, Desconfiado', gradiente: 'bg-gradient-to-r from-pink-400 via-red-500 to-yellow-500' },
  { nome: 'sargitário', imagem: 'https://img.icons8.com/office/64/sagittarius.png', descricao: 'Leal, Sincero, Descuidado, Exagerado', gradiente: 'bg-gradient-to-r from-indigo-400 via-blue-500 to-teal-500' },
  { nome: 'capricórnio', imagem: 'https://img.icons8.com/office/64/capricorn.png', descricao: 'Honesto, Calmo, Rígido, Calculista', gradiente: 'bg-gradient-to-r from-teal-400 via-cyan-500 to-blue-400' },
  { nome: 'aquário', imagem: 'https://img.icons8.com/office/64/aquarius.png', descricao: 'Criativo, Racional, Nervoso, Radical', gradiente: 'bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500' },
  ...
  { nome: 'leão', imagem: 'https://img.icons8.com/office/64/leo.png', descricao: 'Sedutor, Carismático, Exagerado, Dramático', gradiente: 'bg-gradient-to-r from-green-400 via-yellow-500 to-orange-500' }
];
